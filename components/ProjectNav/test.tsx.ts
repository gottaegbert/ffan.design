...
const ProjectNav = ({ projects, onSelect }) => {
    ...
    useEffect(() => {
        const id = setInterval(goToNextProject, 30000); // 将间隔改为 5 秒
        setIntervalId(id);
           ...
           <div
            ...
            <div
               ...
               <div className={styles.mobileProjectInfo}>
                ...
                {/* <p>[{projects[selectedProjectIndex].tags}] {projects[selectedProjectIndex].time}</p> */}
              </div>
            </div>
           </nav>
